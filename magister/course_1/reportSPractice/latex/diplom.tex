...
\gostklgi{КСУИ.006.P4135.001 ПЗ}
\gostrazrabotchik{Артемов К.} % студента
\gostproveril{Капитонов А.А.} % проверяющего
\gostnormokontroler{}
\gostutverdil{Быстров С.В.}
\gosttitledocument{Пояснительная записка}
\gosttitlecompany{НИУ ИТМО\\КСУиИ, гр. P4135}
